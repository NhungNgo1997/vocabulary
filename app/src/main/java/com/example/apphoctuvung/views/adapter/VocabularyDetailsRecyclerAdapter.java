...
public class VocabularyDetailsRecyclerAdapter extends RecyclerView.Adapter<VocabularyDetailsRecyclerAdapter.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull VocabularyDetailsRecyclerAdapter.MyViewHolder holder, int position) {
        holder.binding();
    }
